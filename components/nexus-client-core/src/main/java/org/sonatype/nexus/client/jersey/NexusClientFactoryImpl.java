 ...
 */
package org.sonatype.nexus.client.jersey;
...
import org.sonatype.nexus.client.internal.NexusXStreamFactory;
import org.sonatype.nexus.client.internal.VersionLoader;
import org.sonatype.nexus.client.internal.XStreamXmlProvider;
    ...
    implements NexusClientFactory
{
  ...
  protected String discoverClientVersion() {
    return VersionLoader.readVersion("META-INF/maven/org.sonatype.nexus/nexus-client-core/pom.properties", "unknown");
  }
