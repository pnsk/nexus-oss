...
@Singleton
class SimpleHostedRecipe
    extends RecipeSupport
{
  static final String NAME = 'simple-hosted'
  ...
  @Inject
  Provider<SimpleStorageFacet> storageFacet
  ...
  @Inject
  SimpleStorageHandler storageHandler

  @Inject
  SimpleHostedRecipe(@Named(HostedType.NAME) Type type,
